...
(define (intcode-5-6-7-8-test)
  ...
  (define prog2 (string->intcode-program "3,3,1107,-1,8,3,4,3,99"))
  (machine prog2)
  ...
  (machine prog3)
  (println "Checks if input is zero:")
...
(define (intcode-3-4-test)
  (define machine (intcode-machine (make-hash (list (cons 3 intcode-3)
                                                    (cons 4 intcode-4)
                                                    (cons 99 intcode-99)))))
  (define prog (string->intcode-program "3,0,4,0,99"))
  (machine prog))
(define (intcode-mode-test)
  (define machine (intcode-machine (make-hash (list (cons 2 intcode-2)
                                                    (cons 3 intcode-3)
                                                    (cons 4 intcode-4)
                                                    (cons 99 intcode-99)))))
  (define prog (string->intcode-program "1002,4,3,4,33"))
  (machine prog))
